...
const MistralIconRaw: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 256 233" {...props}>
...
export const MistralIcon = (props: ComponentProps<typeof MistralIconRaw>) => <MistralIconRaw {...props} />;