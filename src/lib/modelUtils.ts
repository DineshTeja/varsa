...
export const availableModels: ModelWithIcon[] = [
  ...
  { id: 'gpt-4.5', name: 'GPT-4.5', icon: AiOutlineOpenAI, provider: 'openai', contextWindow: 128000, inputCostPerMillionTokens: 10, outputCostPerMillionTokens: 30 },
  { id: 'gpt-4.1', name: 'GPT-4.1', icon: AiOutlineOpenAI, provider: 'openai', contextWindow: 128000, inputCostPerMillionTokens: 10, outputCostPerMillionTokens: 30 },
  { id: 'o3', name: 'GPT-o3', icon: AiOutlineOpenAI, provider: 'openai', contextWindow: 128000, inputCostPerMillionTokens: 10, outputCostPerMillionTokens: 30 },
  { id: 'o3-mini', name: 'GPT-o3-mini', icon: AiOutlineOpenAI, provider: 'openai', contextWindow: 128000, inputCostPerMillionTokens: 5, outputCostPerMillionTokens: 15 },
  ...
  { id: 'claude-3-7-sonnet-latest', name: 'Claude 3.7 Sonnet', icon: SiAnthropic, provider: 'anthropic', cacheControl: true, contextWindow: 200000, inputCostPerMillionTokens: 3, outputCostPerMillionTokens: 15 },
  ...
  { id: 'mistral-large-2', name: 'Mistral Large 2', provider: 'mistral', icon: MistralIcon, contextWindow: 123000, inputCostPerMillionTokens: 2.7, outputCostPerMillionTokens: 8.1 },
  ...
  { id: 'mixtral-8x22b', name: '(Groq) Mixtral 8x22B', provider: 'groq', icon: GroqIcon, contextWindow: 141000, inputCostPerMillionTokens: 0.27, outputCostPerMillionTokens: 0.27 },
  ...
  { id: 'command-r', name: '(Cohere) Command R', provider: 'cohere', icon: CohereIcon, contextWindow: 128000, inputCostPerMillionTokens: 3, outputCostPerMillionTokens: 15 },
  ...
  { id: 'gemini-2.5-pro', name: '(Google) Gemini 2.5 Pro', provider: 'google', icon: SiGooglegemini, contextWindow: 2000000, inputCostPerMillionTokens: 0, outputCostPerMillionTokens: 0 },
  { id: 'gemini-2.0-flash-lite', name: '(Google) Gemini 2.0 Flash-Lite', provider: 'google', icon: SiGooglegemini, contextWindow: 2000000, inputCostPerMillionTokens: 0, outputCostPerMillionTokens: 0 },
  { id: 'gemini-2.0-pro', name: '(Google) Gemini 2.0 Pro', provider: 'google', icon: SiGooglegemini, contextWindow: 2000000, inputCostPerMillionTokens: 0, outputCostPerMillionTokens: 0 },
